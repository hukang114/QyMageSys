...
public class AuditorListAdapter extends BaseQuickAdapter<GetTreeEnt, BaseViewHolder> {


    public AuditorListAdapter(int layoutResId, @Nullable List<GetTreeEnt> data) {
